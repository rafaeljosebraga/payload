    ...
    <section id="hero" className="relative pt-20 sm:pt-24 md:pt-32 lg:pt-40 pb-40 md:pb-56 overflow-hidden bg-gradient-to-br from-ndti-950 via-ndti-900 to-ndti-800">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-1/2 mb-8 md:mb-0 animate-fade-in-proportional">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white mb-6 group cursor-pointer transition-all hover:bg-white/20">
              <Sparkles className="w-4 h-4 mr-2 group-hover:text-yellow-300 transition-colors" />
              <span className="text-sm">Transformando ideias em inovação</span>
            </div>

            <div className="flex flex-col items-start px-proportional-sm max-w-2xl">
              <h1 className="hero-title font-bold text-white leading-tight text-left w-full mb-4">
              ...
              <p className="hero-subtitle text-gray-200 leading-relaxed text-justify w-full mb-6">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#servicos"
                className="inline-flex items-center px-6 py-3 bg-ifnmg-blue text-white rounded-lg hover:bg-ndti-700 hover:shadow-lg hover:shadow-ndti-700/30 transition-all duration-300 group"
              >
                Nossos Serviços
              ...
              <a
                href="#contato"
                className="inline-flex items-center px-6 py-3 border border-white/30 text-white rounded-lg hover:bg-white/10 hover:border-white/50 backdrop-blur-sm transition-all duration-300 group"
              >
                Entre em Contato
