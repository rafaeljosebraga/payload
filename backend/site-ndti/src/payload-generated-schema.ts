...
export const media = pgTable(
  'media',
  {
    ...
    sizes_miniatura_url: varchar('sizes_miniatura_url'),
    sizes_miniatura_width: numeric('sizes_miniatura_width'),
    sizes_miniatura_height: numeric('sizes_miniatura_height'),
    sizes_miniatura_mimeType: varchar('sizes_miniatura_mime_type'),
    sizes_miniatura_filesize: numeric('sizes_miniatura_filesize'),
    sizes_miniatura_filename: varchar('sizes_miniatura_filename'),
    sizes_cartao_url: varchar('sizes_cartao_url'),
    sizes_cartao_width: numeric('sizes_cartao_width'),
    sizes_cartao_height: numeric('sizes_cartao_height'),
    sizes_cartao_mimeType: varchar('sizes_cartao_mime_type'),
    sizes_cartao_filesize: numeric('sizes_cartao_filesize'),
    sizes_cartao_filename: varchar('sizes_cartao_filename'),
  ...
  (columns) => ({
    ...
    media_sizes_miniatura_sizes_miniatura_filename_idx: index(
      'media_sizes_miniatura_sizes_miniatura_filename_idx',
    ).on(columns.sizes_miniatura_filename),
    media_sizes_cartao_sizes_cartao_filename_idx: index(
      'media_sizes_cartao_sizes_cartao_filename_idx',
    ).on(columns.sizes_cartao_filename),
