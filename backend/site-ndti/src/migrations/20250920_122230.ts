...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ...
   -- Tabela tipo_noticia (categorias dinâmicas de notícias)
   ...
   -- Tabela categoria_projeto (categorias dinâmicas de projetos)
   ...
   -- Tabela news com relacionamento para tipo_noticia
   ...
   -- Tabela projects com relacionamento para categoria_projeto
   ...
   CREATE TABLE "equipment" (
   	...
   	"acquisition_year" numeric NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ...
   DROP TABLE IF EXISTS "categoria_projeto" CASCADE;
   DROP TABLE IF EXISTS "projects_technologies" CASCADE;
   DROP TABLE IF EXISTS "projects_long_description" CASCADE;
   DROP TABLE IF EXISTS "projects_features" CASCADE;
   DROP TABLE IF EXISTS "projects_team" CASCADE;
   DROP TABLE IF EXISTS "projects" CASCADE;
   DROP TABLE IF EXISTS "team_skills" CASCADE;
   ...
   DROP TYPE IF EXISTS "enum_site_images_slug";`)
}
