...
--   '/media/pexels-photo-1108099.jpeg', '/media/pexels-photo-1108099-400x300.jpeg', 'pexels-photo-1108099.jpeg', 'image/jpeg', 1273919, 5000, 3333, 0.5, 0.5,
--   '/media/pexels-photo-1108099-400x300.jpeg', 400, 300, 'image/jpeg', 42588, 'pexels-photo-1108099-400x300.jpeg',
--   '/media/pexels-photo-1108099-768x1024.jpeg', 768, 1024, 'image/jpeg', 161045, 'pexels-photo-1108099-768x1024.jpeg',
--   '/media/pexels-photo-1108099-1024x683.jpeg', 1024, 683, 'image/jpeg', 142345, 'pexels-photo-1108099-1024x683.jpeg'
-- );
--
-- -- Exemplo 2: Baseado na URL de uma foto de montanhas em Minas Gerais.
-- -- URL Original: https://images.pexels.com/photos/13106659/pexels-photo-13106659.jpeg
-- INSERT INTO public.media(
--   id, alt, updated_at, created_at, 
--   url, thumbnail_u_r_l, filename, mime_type, filesize, width, height, focal_x, focal_y, 
--   sizes_thumbnail_url, sizes_thumbnail_width, sizes_thumbnail_height, sizes_thumbnail_mime_type, sizes_thumbnail_filesize, sizes_thumbnail_filename, 
...
--   sizes_tablet_url, sizes_tablet_width, sizes_tablet_height, sizes_tablet_mime_type, sizes_tablet_filesize, sizes_tablet_filename
-- ) VALUES (
--   nextval('media_id_seq'::regclass), 'Pico da Bandeira, Minas Gerais, com um mar de nuvens ao amanhecer.', now(), now(),
--   '/media/pexels-photo-13106659.jpeg', '/media/pexels-photo-13106659-400x300.jpeg', 'pexels-photo-13106659.jpeg', 'image/jpeg', 2183307, 2970, 5280, 0.5, 0.5,
--   '/media/pexels-photo-13106659-400x300.jpeg', 400, 300, 'image/jpeg', 51450, 'pexels-photo-13106659-400x300.jpeg',
--   '/media/pexels-photo-13106659-768x1024.jpeg', 768, 1024, 'image/jpeg', 185670, 'pexels-photo-13106659-768x1024.jpeg',
--   '/media/pexels-photo-13106659-1024x1820.jpeg', 1024, 1820, 'image/jpeg', 298450, 'pexels-photo-13106659-1024x1820.jpeg'
-- );
--
-- -- Exemplo 3: Baseado em uma URL de um logotipo de placeholder.
-- -- URL Original: https://i.imgur.com/2sN3fTf.png
-- INSERT INTO public.media(
--   id, alt, updated_at, created_at, 
--   url, thumbnail_u_r_l, filename, mime_type, filesize, width, height, focal_x, focal_y, 
--   sizes_thumbnail_url, sizes_thumbnail_width, sizes_thumbnail_height, sizes_thumbnail_mime_type, sizes_thumbnail_filesize, sizes_thumbnail_filename, 
...
--   sizes_tablet_url, sizes_tablet_width, sizes_tablet_height, sizes_tablet_mime_type, sizes_tablet_filesize, sizes_tablet_filename
-- ) VALUES (
--   nextval('media_id_seq'::regclass), 'Logotipo de placeholder quadrado com um ícone de imagem.', now(), now(),
--   '/media/2sN3fTf.png', '/media/2sN3fTf-400x300.png', '2sN3fTf.png', 'image/png', 9432, 512, 512, 0.5, 0.5,
--   '/media/2sN3fTf-400x300.png', 400, 300, 'image/png', 7230, '2sN3fTf-400x300.png',
--   '/media/2sN3fTf-768x1024.png', 768, 1024, 'image/png', 18950, '2sN3fTf-768x1024.png',
--   '/media/2sN3fTf-1024x1024.png', 1024, 1024, 'image/png', 22500, '2sN3fTf-1024x1024.png'
-- );
--
